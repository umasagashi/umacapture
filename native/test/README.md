...
`src/condition/serializer.cpp` and `src/chara_detail/chara_detail_scene_scraper.cpp`,
which pull in OpenCV via `cv/frame.h` but not ONNX or WinRT. As the header/.cpp
